...
| Attribute                 | Value                               |
| ------------------------- | ----------------------------------- |
| Permalink                 | michigan-tech-con-2024              |
| Engagement Type           | Conference                          |
| Status                    | Completed                           |
| Name                      | Michigan Technology Conference 2024 |
| Country Code              | US                                  |
| Country Division Code     | MI                                  |
| City                      | Pontiac                             |
| Venue                     | UWM Sports Complex                  |
| Overview Location         | Pontiac, MI                         |
| Listing Location          | Pontiac, MI                         |
...
| Starting Cost             | $399                                |
| Ending Cost               | $399                                |
| Url                       | https://www.mitechcon.org/          |
| Include In Public Profile | true                                |
| Is Virtual                | false                               |
| Is Hybrid                 | false                               |
| Is Enabled                | true                                |
...
The Michigan Technology Conference (MITechCon) is a two-day technology conference taking place on March 21 to March 22, 2024. Join us at the spacious UWM Sports Complex for two days of content covering the forefront of technology. This event is a unique opportunity in Southeast Michigan to collaborate with IT professionals across the variety of industries in our state.

### Summary

The Michigan Technology Conference is a two-day event where Midwestern tech professionals and businesses come together to connect, discover, and showcase.

## Call for Speaker Attributes

| Attribute                   | Value                             |
| --------------------------- | --------------------------------- |
| Status                      | Closed                            |
| Url                         | https://sessionize.com/mitechcon/ |
| Start Date                  | 2023-09-01                        |
| End Date                    | 2023-09-30                        |
| Expected Decision Date      |                                   |
| Actual Decision Date        | 2023-10-17                        |
| Includes Speaker Honorarium | false                             |
| Speaker Honorarium Amount   |                                   |
| Speaker Honorarium Currency |                                   |
| Speaker Honorarium Notes    |                                   |
| Includes Travel Expenses    | false                             |
| Travel Expense Notes        |                                   |
| Includes Accommodations     | true                              |
| Accommodation Notes         | 2 nights                          |
| Event Fee Covered           | true                              |
| Event Fee Notes             |                                   |
| Submission Limit            | 10                                |
...
| Attribute                   | Value                                                        |
| --------------------------- | ------------------------------------------------------------ |
| Presentation Permalink      | reevaluating-software-design-patterns                        |
| Status                      | Completed                                                    |
| Presentation Length         | 60                                                           |
| Engagement Presentation Url | https://whova.com/embedded/speaker_session_detail/sSl1REch6PG9uNXkYg7SzQQRewr%40cCXmOE80tE6Fywo%3D/3640508/ |
| LanguageCode                | en                                                           |
| Title                       | Reevaluating Software Design Patterns: Uncovering Patterns That Can Be More Burden Than Benefit |
| Room                        | Clean Coders Room                                            |
| Start Date/Time             | 2024-03-21 15:00:00                                          |
...
| Attribute                   | Value                                                        |
| --------------------------- | ------------------------------------------------------------ |
| Presentation Permalink      | technical-debt-is-not-free                                   |
| Status                      | Completed                                                    |
| Presentation Length         | 60                                                           |
| Engagement Presentation Url | https://whova.com/embedded/speaker_session_detail/sSl1REch6PG9uNXkYg7SzQQRewr%40cCXmOE80tE6Fywo%3D/3640520/ |
| Language Code               | en                                                           |
| Title                       | Technical Debt Is Not Free                                   |
| Room                        | Cyera Room                                                   |
| Start Date/Time             | 2024-03-21 18:30:00                                          |
...
| Attribute              | Value                                              |
| ---------------------- | -------------------------------------------------- |
| Presentation Permalink | file-new-api-management                            |
| Status                 | Not Selected                                       |
| Presentation Length    | 60                                                 |
| Language Code          | en                                                 |
| Title                  | File New: Build a Fully-Managed and Documented API |
| Room                   | Cyera Room                                         |
| Start Date/Time        | 2024-03-22 17:15:00                                |
...
| Attribute              | Value                                                      |
| ---------------------- | ---------------------------------------------------------- |
| Presentation Permalink | essential-software-design-patterns                         |
| Status                 | Not Selected                                               |
| Presentation Length    | 60                                                         |
| Language Code          | en                                                         |
| Title                  | Essential Software Design Patterns for Optimal Development |
...
| Attribute              | Value                                                   |
| ---------------------- | ------------------------------------------------------- |
| Presentation Permalink | getting-deeper-into-azure-functions                     |
| Status                 | Not Selected                                            |
| Presentation Length    | 60                                                      |
| Language Code          | en                                                      |
| Title                  | Beyond Hello World: Getting Deeper into Azure Functions |
...
| Attribute              | Value                                                        |
| ---------------------- | ------------------------------------------------------------ |
| Presentation Permalink | going-schema-less                                            |
| Status                 | Not Selected                                                 |
| Presentation Length    | 60                                                           |
| Language Code          | en                                                           |
...
| Attribute              | Value                          |
| ---------------------- | ------------------------------ |
| Presentation Permalink | secrets-of-conflict-resolution |
| Status                 | Not Selected                   |
| Presentation Length    | 60                             |
| Language Code          | en                             |
...
| Attribute              | Value                                                        |
| ---------------------- | ------------------------------------------------------------ |
| Presentation Permalink | eda-microservice-from-scratch                                |
| Status                 | Not Selected                                                 |
| Presentation Length    | 60                                                           |
| Language Code          | en                                                           |
| Title                  | File New: Build a Event-Driven Architected Microservice from Scratch |
...
| Attribute              | Value                                            |
| ---------------------- | ------------------------------------------------ |
| Presentation Permalink | time-travelling-data                             |
| Status                 | Not Selected                                     |
| Presentation Length    | 60                                               |
| Language Code          | en                                               |
| Title                  | Time Travelling Data: SQL Server Temporal Tables |
...
| Attribute              | Value                         |
| ---------------------- | ----------------------------- |
| Presentation Permalink | the-few-the-proud-the-leaders |
| Status                 | Not Selected                  |
| Presentation Length    | 60                            |
| Language Code          | en                            |
