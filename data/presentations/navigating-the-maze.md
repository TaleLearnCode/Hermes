...
| Attribute                 | Value                                                        |
| ------------------------- | ------------------------------------------------------------ |
| Permalink                 | navigating-the-maze                                          |
| Title                     | Navigating the Maze: Communicating Architecture Decisions with Architecture Decision Records |
| Short Title               | Communicating Arch Decisions with Arch Decision Records      |
| Presentation Type         | Session                                                      |
| Presentation Status       | Active                                                       |
| Public Repo Link          | https://github.com/TaleLearnCode/NavigatingTheMaze           |
| Private Repo Link         | https://github.com/TaleLearnCode/NavigatingTheMaze-private   |
| Thumbnail                 | https://github.com/TaleLearnCode/NavigatingTheMaze/blob/main/thumbnail.jpg |
