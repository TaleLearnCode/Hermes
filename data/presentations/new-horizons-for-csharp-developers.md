...
| Attribute | Value |
|---|---|
| Permalink | new-horizons-for-csharp-developers |
| Title | New Horizons for C# Developers |
| Short Title | New Horizons for C# Developers |
| Presentation Type | Session |
| Presentation Status | Retired |
| Public Repo Link | https://github.com/TaleLearnCode/new-horizons-for-csharp-developers |
| Private Repo Link |  |
| Thumbnail | https://github.com/TaleLearnCode/new-horizons-for-csharp-developers/blob/main/Thumbnail.jpg |
