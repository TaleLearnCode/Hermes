...
| Attribute | Value |
|---|---|
| Permalink | terraform-swiss-army-knife |
| Title | Terraform: The Developer's Swiss Army Knife for Infrastructure |
| Short Title | Terraform: Developer's Swiss Army Knife for Infrastructure |
| Presentation Type | Session |
| Presentation Status | Active |
| Public Repo Link | https://github.com/TaleLearnCode/TerraformSwissArmyKnife |
| Private Repo Link | https://github.com/TaleLearnCode/TerraformSwissArmyKnife-private |
| Thumbnail | https://github.com/TaleLearnCode/TerraformSwissArmyKnife/blob/main/thumbnail.jpg |
